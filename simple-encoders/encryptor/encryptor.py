...
class Encryptor:
    ...
    def archiving(self, dir_path, arc_path):
        def walk():
    ...
    def unarchiving(self, dir_path, arc_path):
...
if __name__ == "__main__":
    ...
    archiver = Archiver()
    if args.u:
        archiver.unarchiving(dir_path, arc_path)
    else:
        archiver.archiving(dir_path, arc_path)
    logger.debug(f"end::{__name__}")

    # FOR TESTING
    # python encryptor.py "../../_dummy/root_folder/" "../../_dummy/dummy-storage.zip"
